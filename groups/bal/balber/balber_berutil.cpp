...
// MODIFIERS
__out >= d_oldSize && __out <= d_oldSize + newSize
...
// CLASS METHODS
(__out == 0 ==> *accumNumBytesConsumed > 0) && (__out == -1 ==> *accumNumBytesConsumed >= 0)
...
(tagNumber < 0 ==> __out == -1) && (tagNumber >= 0 ==> __out == 0 || __out == -1)
...
// CLASS METHODS
__out == (k_MIN_OFFSET <= value && k_MAX_OFFSET >= value)
