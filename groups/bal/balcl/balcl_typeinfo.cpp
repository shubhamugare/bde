...
// MANIPULATORS
__out.d_elemType == rhs.d_elemType && __out.d_linkedVariable_p == rhs.d_linkedVariable_p && __out.d_isOptionalLinkedVariable == rhs.d_isOptionalLinkedVariable && __out.d_constraint_p == rhs.d_constraint_p
