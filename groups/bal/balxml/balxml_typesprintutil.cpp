...
(bdlb::Float::classifyFine(object) >= bdlb::Float::k_POSITIVE_INFINITY && bdlb::Float::classifyFine(object) <= bdlb::Float::k_SNAN) ==> (__out.fail()) || (!(bdlb::Float::classifyFine(object) >= bdlb::Float::k_POSITIVE_INFINITY && bdlb::Float::classifyFine(object) <= bdlb::Float::k_SNAN
