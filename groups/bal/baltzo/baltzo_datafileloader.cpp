...
(__out == -1 || __out == -2 || __out == 0) && (__out == -1 ==> timeZoneId[0] == '/') && (__out == -2 ==> EXISTS(0, bsl::strlen(timeZoneId), i, !bsl::strchr("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz1234567890/_+-", timeZoneId[i])))
...
(__out == 0) || (__out == u::UNSUPPORTED_ID) || (__out == u::UNSPECIFIED_ERROR)
