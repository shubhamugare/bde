...
(__out == true ==> EXISTS(transitions.begin(), transitions.end(), it, descriptor == it->descriptor())) && (__out == false ==> FORALL(transitions.begin(), transitions.end(), it, descriptor != it->descriptor()))
static
