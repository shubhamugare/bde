...
(__out >= 0 || __out < 0) && (*outputBufferSize == originalBufferSize || *outputBufferSize == static_cast<size_t>(__out) + 1) && (*outputBuffer == originalBuffer || *outputBuffer == guard.get_allocated_buffer())
