...
(lhs.length() == rhs.length() && 0 == memcmp(lhs.str(), rhs.str(), lhs.length())) == __out
...
__out == (testName.isEmpty() || #ifndef BSLS_ASSERTIMPUTIL_AVOID_STRING_CONSTANTS throwName.isEmpty() || #endif throwName == testName)
static
