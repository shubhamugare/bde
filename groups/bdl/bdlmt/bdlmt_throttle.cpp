...
// ACCESSOR
(numActions <= 0 || d_maxSimultaneousActions < numActions || k_ALLOW_NONE == d_nanosecondsPerAction) ==> __out == -1) && ((numActions > 0 && d_maxSimultaneousActions >= numActions && k_ALLOW_NONE != d_nanosecondsPerAction) ==> __out == 0
