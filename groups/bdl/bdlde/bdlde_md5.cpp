...
// FREE OPERATORS
(__out == true) == ((lhs.d_length == rhs.d_length) && (bsl::memcmp(lhs.d_state, rhs.d_state, sizeof lhs.d_state) == 0) && (bsl::memcmp(lhs.d_buffer, rhs.d_buffer, (sizeof *lhs.d_buffer) * getLengthInUse(lhs.d_length)) == 0))
