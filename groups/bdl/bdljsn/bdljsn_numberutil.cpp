...
/// advanced).
(__out == true ==> *iter <= end) && (__out == false ==> *iter <= end)
...
(__out == false) || (lhs.d_isExpNegative == rhs.d_isExpNegative && lhs.d_significantDigits == rhs.d_significantDigits && lhs.d_exponent == rhs.d_exponent)
