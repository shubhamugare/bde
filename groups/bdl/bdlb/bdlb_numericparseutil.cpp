...
(positiveNum.size() > 0 && positiveNum[0] == '+' ==> __out.size() == positiveNum.size() - 1) && (positiveNum.size() > 0 && positiveNum[0] != '+' ==> __out.size() == positiveNum.size())
static
inline
...
(stdlibInput.size() >= 2 && (stdlibInput.substr(0, 2) == "0x" || stdlibInput.substr(0, 2) == "0X")) ==> __out == true && ((stdlibInput.size() < 2 || stdlibInput.substr(0, 2) != "0x" && stdlibInput.substr(0, 2) != "0X") ==> __out == false)
static
