...
(state == e_EMPTY || state == e_WRITING || state == e_FULL || state == e_READING) ==> __out != 0
...
/// array.
static_cast<unsigned int>(__out) == (encodedState & k_ELEMENT_STATE_MASK)
inline
...
/// the disabled flag.
(__out | k_DISABLED_STATE_MASK) == (encodedPushIndex | k_DISABLED_STATE_MASK)
inline
